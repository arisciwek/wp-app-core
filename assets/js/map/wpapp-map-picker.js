 ...
 * @author      arisciwek
 *
 * Path: /wp-app-core/assets/js/map/wpapp-map-picker.js
 *
 * Description: Shared map picker component menggunakan Leaflet.js.
 *              Digunakan oleh semua wp-app-* plugins (wp-customer, wp-agency, dll).
 *              Includes map initialization, marker management,
 *              dan koordinat updating untuk form dengan map.
 ...
 *
 * Usage:
 * - window.MapPicker.init() - Initialize map in current visible container
 * - window.MapPicker.cleanup() - Cleanup map instance
 * - window.MapPicker.map - Access Leaflet map instance
 * - window.MapPicker.marker - Access Leaflet marker instance
 *
 * Changelog:
 * 1.0.0 - 2025-11-02 (Global Migration)
 * - Migrated to wp-app-core as global shared component
 * - Renamed from map-picker.js to wpapp-map-picker.js
 * - Now usable by all wp-app-* plugins
 * - Removed plugin-specific dependencies
 * - Enhanced documentation for multi-plugin usage
 */
(function($) {
    'use strict';
