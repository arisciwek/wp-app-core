...
<div class="platform-settings-general">
    <form method="post" action="options.php" id="platform-general-settings-form">
        <?php settings_fields('wp_app_core_platform_settings'); ?>
        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="wp_app_core_platform_settings[company_name]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="wp_app_core_platform_settings[company_tagline]"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="wp_app_core_platform_settings[company_address]" id="company_address"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="wp_app_core_platform_settings[company_city]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="wp_app_core_platform_settings[company_country]"
        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="wp_app_core_platform_settings[company_phone]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" name="wp_app_core_platform_settings[company_email]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" name="wp_app_core_platform_settings[company_website]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" name="wp_app_core_platform_settings[support_email]"
        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <select name="wp_app_core_platform_settings[timezone]" id="timezone">
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        <select name="wp_app_core_platform_settings[date_format]" id="date_format">
                ...
                <tr>
                    ...
                    <td>
                        <select name="wp_app_core_platform_settings[default_language]" id="default_language">
