        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="platform_settings[company_name]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="platform_settings[company_tagline]"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="platform_settings[company_address]" id="company_address"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="platform_settings[company_city]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="platform_settings[company_country]"
        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="platform_settings[company_phone]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" name="platform_settings[company_email]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" name="platform_settings[company_website]"
                ...
                <tr>
                    ...
                    <td>
                        <input type="email" name="platform_settings[support_email]"
        ...
        <div class="settings-section">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <select name="platform_settings[timezone]" id="timezone">
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        <select name="platform_settings[date_format]" id="date_format">
                ...
                <tr>
                    ...
                    <td>
                        <select name="platform_settings[default_language]" id="default_language">
