...
<div class="wrap wp-app-core-security-session-wrap">
    ...
    <form method="post" action="options.php" class="wp-app-core-security-session-form">
        <?php
        ...
        <p class="submit">
            <?php submit_button(__('Save Session Settings', 'wp-app-core'), 'primary', 'submit', false); ?>
            <button type="button" id="reset-security-session" class="button button-secondary" style="margin-left: 10px;">
